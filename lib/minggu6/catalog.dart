...
import 'package:alkademi_latihan/minggu6/catalog_card.dart';
import 'package:alkademi_latihan/models/product.dart';
import 'package:flutter/material.dart';

class CatalogChart extends StatefulWidget {
  const CatalogChart({super.key});

  @override
  State<CatalogChart> createState() => _CatalogChartState();
}

class _CatalogChartState extends State<CatalogChart> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        return CatalogProductCardProvider(product: products[index]);
      },),
    );
  }
}
